...
class ApplyJobForm(ModelForm):
    ...
    class Meta:
        ...
        'Sp_DOB': DateInput(attrs={'class': 'form-control'}), 
        ...
        'F_DOB': DateInput(attrs={'class': 'form-control'}), 
        ...
        'M_DOB': DateInput(attrs={'class': 'form-control'}), 
        ...
        'C1_DOB': DateInput(attrs={'class': 'form-control'}), 
        ...
        'C2_DOB': DateInput(attrs={'class': 'form-control'}), 
