...
class ApplyJob (models.Model):
    ...
    Last_Worked  = models.CharField(null=True, blank=True, max_length=150)
    ...
    Present_Salary = models.CharField(null=True, blank=True, max_length=10)
    ...
    Sp_DOB = models.DateField(null=True, blank=True)
    ...
    C1_DOB = models.DateField(null=True, blank=True)
    ...
    C2_DOB = models.DateField(null=True, blank=True)
